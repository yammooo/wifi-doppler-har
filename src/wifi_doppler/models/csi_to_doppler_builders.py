...
from wifi_doppler.models.csi_to_doppler_2d_shared import SharedAntennaCsiToDopplerUNet2D
...
_ARCHITECTURES: dict[str, tuple[type[torch.nn.Module], str, str]] = {
    ...
    "unet2d_shared_antenna_full_resolution": (
        ...
        "wifi_doppler.models.csi_to_doppler_2d_shared.SharedAntennaCsiToDopplerUNet2D",
    ),
    "unet1d_spatial_head": (
    ...
    "unet1d_spatial_head_shared_antenna": (
        ...
        "wifi_doppler.models.csi_to_doppler_shared_antenna.SharedAntennaCsiToDopplerUNet1DSpatialHead",
    ),
}
