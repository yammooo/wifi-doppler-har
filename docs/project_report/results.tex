...
\(4.194\times10^{-5}\). Both reproduced the selected peaks. Thus, the end-to-end training path is functioning correctly, and the model has sufficient capacity to memorize the selected local examples, although this test says nothing about generalization.
